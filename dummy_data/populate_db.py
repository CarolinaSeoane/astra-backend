...
class Populate:
    ...
    sprint5_q3_team3 = ObjectId()
    sprint6_q3_team3 = ObjectId()
    sprint7_q3_team3 = ObjectId()
    ...
    sprint6_q4_team3 = ObjectId()
    sprint7_q4_team3 = ObjectId()
    ...
    def populate_sprints(self):
        sprints = [
            ...
            },
            {
                ...
                "quarter": 3,
                "year": 2024,
                "start_date": datetime.datetime(2024, 8, 13),
            ...
            {
                "_id": self.sprint5_q3_team3,
                "name": "S5-Q3-2024",
                "sprint_number": 5,
                "quarter": 3,
                "year": 2024,
                "start_date": datetime.datetime(2024, 8, 27),
                "end_date": datetime.datetime(2024, 9, 9),
                "target": 1,
                "completed": 1,
                "status": SprintStatus.FINISHED.value,
                "team": self.team3_id
            ...
            },
            {
                ...
                "end_date": datetime.datetime(2024, 11, 4),
                "target": 1,
                "completed": 1,
                "status": SprintStatus.FINISHED.value,
                "team": self.team3_id
            ...
            {
                "_id": self.sprint7_q4_team3,
                "name": "S7-Q4-2024",
                "sprint_number": 7,
                "quarter": 4,
                "year": 2024,
                "start_date": datetime.datetime(2024, 12, 31),
                "end_date": datetime.datetime(2024, 1, 13),
                "status": SprintStatus.FUTURE.value,
                "team": self.team3_id
            },
        ]
