...
@use_args({
    ...
    ## customization
    # 'quarter': fields.Integer(required=False), # affects sprints (TODO: should affect epics too!!!!)
...
def filters(args):
    ...
    if args['sprints']:
        sprints = Sprint.get_sprints(g.team_id, args.get('quarter'), args.get('year'), args.get('future'))
